...
```{r }
  ...
  #prepare dap data
	...
	#sample lidar strips
	set.seed(55)
	samp_pts_tn = sp::spsample(ply_tn_las,10,"random")
  ...
  #reproject lidar dtms to match DAP projection
	if(!file.exists(out_dtm_tn_dap)){
	  ...
	  gdalUtils::gdalbuildvrt( files_dtm_tn_dap, out_dtm_tn_dap)
	}
	...
	las3_lid = readLAS("D:/temp/tennessee/clip_las/clipHt_noBuf/clip_3.las")
	las3_dap = readLAS("D:/temp/tennessee/clip_dap/clipHt_noBuf/clip_3.las")

	plot(las3_lid)
	plot(las3_dap)
	proj_las = "+proj=lcc +lat_1=35.25 +lat_2=36.41666666666666 +lat_0=34.33333333333334 +lon_0=-86 +x_0=600000.0000000001 +y_0=0 +ellps=GRS80 +datum=NAD83 +to_meter=0.3048006096012192 +no_defs"
	proj4string(las3_lid) = proj_las
	proj4string(las3_lid) = sp::CRS("+init=epsg:102736")
	proj4string(las3_dap) = "+proj=utm +zone=16 +ellps=GRS80 +units=m +no_defs" 
	las3_dap_rp = lidR::lastransform(las3_dap,proj_las)
	
	lidR::epsg(las3_lid) = 102736
	epsg(las3_dap)
	rgdal::checkCRSArgs("+EPSG:102736")
	rgdal::checkCRSArgs("+proj=lcc +lat_1=35.25 +lat_2=36.41666666666666 +lat_0=34.33333333333334 +lon_0=-86 +x_0=600000.0000000001 +y_0=0 +ellps=GRS80 +datum=NAD83 +to_meter=0.3048006096012192 +no_defs")
	rgdal::checkCRSArgs("+init=epsg:102736")
	
	sp::CRS("+init=epsg:102736")
